<template>
  <div class="login-wrap" v-show="showLogin">
    ...
    <button v-on:click="login" :loading="loading">登录</button>
    <!-- 这里不应该用路由？？ -->
    <span @click="ToRegister">没有账号？马上注册</span>
    <div>
      <p>数据响应式测试</p>
      <div>测试一：{{cjData.a}}</div>
      <div>测试二：{{cjData.b}}</div>
      <div>测试三：{{message}}</div>
